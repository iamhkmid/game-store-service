...
import { TGraphqlCtx } from '../graphql/graphql.types';
...
export type UserResolvers<ContextType = TGraphqlCtx, ParentType extends ResolversParentTypes['User'] = ResolversParentTypes['User']> = {
